...
arm_cassie_sim_upright = _libraries['./libcassiemujoco.so'].arm_cassie_sim_upright
arm_cassie_sim_upright.restype = None
arm_cassie_sim_upright.argtypes = [POINTER_T(struct_cassie_sim)]

cassie_forceandtorque = _libraries['./libcassiemujoco.so'].cassie_forceandtorque
cassie_forceandtorque.restype = POINTER_T(ctypes.c_double)
cassie_forceandtorque.argtypes = [POINTER_T(struct_cassie_sim)]

arm_set_torque =  _libraries['./libcassiemujoco.so'].arm_set_torque
arm_set_torque.restype = None
arm_set_torque.argtypes = [POINTER_T(ctypes.c_double)]

arm_set_gripper = _libraries['./libcassiemujoco.so'].arm_set_gripper
arm_set_gripper.restype = None
arm_set_gripper.argtypes = [POINTER_T(struct_cassie_sim), ctypes.c_bool]
...
arm_set_gain = _libraries['./libcassiemujoco.so'].arm_set_gain
arm_set_gain.restype = None
arm_set_gain.argtypes = [POINTER_T(ctypes.c_double),POINTER_T(ctypes.c_double), POINTER_T(ctypes.c_double) ]
...
__all__ = \
    ...
    'cassie_sim_set_const', 'arm_cassie_sim_upright','arm_set_torque',
    ...
    'cassie_sim_heeltoe_forces','arm_set_gain','arm_set_gripper','cassie_forceandtorque']
